...
`,T=s.memo((function({children:e,className:t="",defaultName:n,label:r,onClick:o,override:d,toggle:u,value:m,withSidebar:h}){const p=(0,i.J)(),g=(0,l.Z)(p,m?String(m):void 0),[b,x]=(0,s.useState)((()=>V((m||"").toString(),void 0,n))),A=(0,s.useContext)(c);(0,s.useEffect)((()=>{const{accountId:e,accountIndex:t,identity:s,nickname:i}=g||{},r=(e||m||"").toString();s?.parent&&B.set(r,s.parent.toString()),p&&(0,f.m)(p.query.identity?.identityOf)?x((()=>s?.display?function(e,t){const n=t.judgements.filter((([,e])=>!e.isFeePaid)),s=n.some((([,e])=>e.isKnownGood||e.isReasonable)),i=n.some((([,e])=>e.isErroneous||e.isLowQuality)),r=s?t?.display:(t?.display||"").replace(/[^\x20-\x7E]/g,""),o=t.displayParent&&(s?t.displayParent:t.displayParent.replace(/[^\x20-\x7E]/g,"")),l=(c=(0,a.jsxs)("span",{className:"name"+(s&&!i?" isGood":""),children:[(0,a.jsx)("span",{className:"top",children:o||r}),o&&(0,a.jsx)("span",{className:"sub",children:`/${r||""}`})]}),d=i?"red":s?"green":"gray",u=t.parent?"link":s&&!i?"check":"minus",(0,a.jsxs)("span",{className:"via-identity",children:[(0,a.jsx)(C,{color:d,icon:u,isSmall:!0}),c]}));var c,d,u;return S.set(e,l),l}(r,s):V(r,t))):x(i||L(n,r,t))}),[p,n,g,u,m]);const v=(0,s.useCallback)((()=>x(L(n,(m||"").toString()))),[n,m]),w=(0,s.useCallback)((()=>A&&m&&A([m.toString(),v])),[v,A,m]);return(0,a.jsxs)(P,{className:`${t}  ui--AccountName ${h?"withSidebar":""}`,"data-testid":"account-name",onClick:h?w:o,children:[r||"",d||b,e]})}));var M=n(37198),F=n(69780),z=n(90778),Z=n(43151);function R(e,{data:t,hash:n,isText:s,type:i}){return Object.entries(F.N).map((([r,{chains:o,create:l,homepage:c,isActive:d,paths:u,ui:m}])=>{const h=o[e],p=u[i];return d&&h&&p?(0,a.jsx)("a",{href:l(h,p,t,n),rel:"noopener noreferrer",target:"_blank",title:`${r}, ${c}`,children:s?r:(0,a.jsx)("img",{src:m.logo})},r):null})).filter((e=>!!e))}const $=v.z.div`
  text-align: right;
...
`,H=s.memo((function({className:e="",data:t,hash:n,isSidebar:i,isSmall:r,isText:o,type:l,withTitle:c}){const{t:d}=(0,Z.$)(),{systemChain:u}=(0,z.h)(),m=(0,s.useMemo)((()=>R(u,{data:t,hash:n,isSidebar:i,isText:o,type:l})),[u,t,n,i,o,l]);return m.length||c?(0,a.jsxs)($,{className:`${e} ui--LinkExternal ${o?"isText":"isLogo"} ${c?"isMain":""} ${r?"isSmall":""} ${i?"isSidebar":""}`,children:[o&&!r&&(0,a.jsx)("div",{children:d("View this externally")}),c&&(0,a.jsx)("h5",{children:d("external links")}),(0,a.jsx)("div",{className:"links",children:m.length?m.map(((e,t)=>(0,a.jsx)("span",{children:e},t))):(0,a.jsx)("div",{children:d("none")})})]}):null})),q=v.z.div`
  display: block;
  line-height: 1rem;
  margin: 0 auto;
  text-align: center;
...
`,O=s.memo((function({children:e,className:t="",isCentered:n}){return(0,a.jsxs)(Q,{className:`${t} ui--Button-Group ${n?"isCentered":""}`,children:[e,(0,a.jsx)("div",{className:"clear"})]})})),W=v.z.button`
  background: transparent;
  border: none;
  color: inherit;
  cursor: pointer;
...
`,G=s.memo((function({activeOnEnter:e,children:t,className:n="",dataTestId:i="",icon:r,isBasic:o,isBusy:l,isCircular:c,isDisabled:d,isFull:u,isIcon:m,isSelected:h,isToplevel:p,label:g,onClick:f,isReadOnly:b=!f,onMouseEnter:x,onMouseLeave:v,tabIndex:w,withoutLink:y}){const j=(0,s.useCallback)((()=>{!l&&!d&&f&&Promise.resolve(f()).catch(console.error)}),[l,d,f]),C=(0,s.useCallback)((()=>{x&&Promise.resolve(x()).catch(console.error)}),[x]),k=(0,s.useCallback)((()=>{v&&Promise.resolve(v()).catch(console.error)}),[v]),N=(0,s.useCallback)((e=>{l||d||"Enter"!==e.key||f&&Promise.resolve(f()).catch(console.error)}),[l,d,f]);return(0,s.useEffect)((()=>(e&&window.addEventListener("keydown",N,!0),()=>{e&&window.removeEventListener("keydown",N,!0)})),[e,N]),(0,a.jsxs)(W,{className:`${n} ui--Button ${g?"hasLabel":""} ${o?"isBasic":""} ${c?"isCircular":""} ${u?"isFull":""} ${m?"isIcon":""} ${l||d?"isDisabled":""} ${l?"isBusy":""} ${b?"isReadOnly":""}${h?"isSelected":""} ${p?"isToplevel":""} ${y?"withoutLink":""}`,"data-testid":i,onClick:j,onMouseEnter:C,onMouseLeave:k,tabIndex:w,children:[r&&(0,a.jsx)(A.Z,{icon:r}),g,t,l&&(0,a.jsx)(U,{className:"ui--Button-spinner",variant:"cover"})]})}));G.Group=O;const J=G,K=v.z.div`
...
`,Y=s.memo((function({button:e,children:t,className:n="",dataTestId:s="",onClose:i,position:r,sidebarRef:o}){return(0,a.jsxs)(K,{className:`${n} ui--Sidebar ${r}Position`,"data-testid":s,ref:o,children:[(0,a.jsxs)(J.Group,{className:"ui--Sidebar-buttons",children:[e,(0,a.jsx)(J,{dataTestId:"close-sidebar-button",icon:"times",isBasic:!0,isCircular:!0,onClick:i})]}),t]})}));var X=n(69316),_=n(69356),ee=n(54383),te=n(58607),ne=n(65874),ae=n(82671),se=n(95292),ie=n(92730),re=n(52107);const oe=s.memo((function({accountId:e,className:t="",label:n=""}){const[i,r]=(0,s.useState)("unknown");return(0,s.useEffect)((()=>{const t=(0,b.C9)(e);"unknown"!==t&&r(t)}),[e]),(0,a.jsxs)("div",{className:`${t} ui--CryptoType`,children:[n,i]})}));let le=0;const ce=v.z.div`
  white-space: nowrap;

  .ui--FormatBalance {
    display: inline-block;
  }
`,de=s.memo((function({className:e="",value:t}){const{t:n}=(0,Z.$)(),i=(0,ee.C)(),[r]=(0,s.useState)((()=>`${Date.now()}-democracy-locks-${++le}`)),[{maxBalance:o,sorted:l},c]=(0,s.useState)({maxBalance:se.nw,sorted:[]});return(0,s.useEffect)((()=>{i&&c((e=>{const s=function(e,t,n=[]){return{maxBalance:(0,re.x)(...n.map((({balance:e})=>e)).filter((e=>!!e))),sorted:n.map((e=>[e,e.unlockAt&&e.unlockAt.gt(t)?e.unlockAt.sub(t):se.nw])).sort(((e,t)=>(e[0].referendumId||se.nw).cmp(t[0].referendumId||se.nw))).sort(((e,t)=>e[1].cmp(t[1]))).sort(((e,t)=>e[0].isFinished===t[0].isFinished?0:e[0].isFinished?-1:1)).reduce(((t,[{balance:n,isDelegated:s,isFinished:i=!1,referendumId:r,vote:o},l])=>{const c=l.gt(se.nw),d=r&&o?(0,a.jsxs)("div",{children:["#",r.toString()," ",(0,ie.a)(n,{forceUnit:"-"})," ",o.conviction?.toString(),s&&"/d"]}):(0,a.jsx)("div",{children:e("Prior locked voting")}),u=t.length?t[t.length-1]:null;return!u||c||i!==u.isFinished?t.push({details:(0,a.jsx)("div",{className:"faded",children:c?(0,a.jsx)(ne.Z,{label:`${e("{{blocks}} blocks",{replace:{blocks:(0,p.u)(l)}})}, `,value:l}):e(i?"lock expired":"ongoing referendum")}),headers:[d],isCountdown:c,isFinished:i}):u.headers.push(d),t}),[])}}(n,i,t);return e.sorted.length!==s.sorted.length||e.sorted.some(((e,t)=>e.headers.length!==s.sorted[t].headers.length))?s:e}))}),[i,n,t]),l.length?(0,a.jsxs)(ce,{className:e,children:[(0,a.jsx)(te.Z,{labelPost:(0,a.jsx)(A.Z,{icon:"clock",tooltip:r}),value:o}),(0,a.jsx)(w.Z,{trigger:r,children:l.map((({details:e,headers:t},n)=>(0,a.jsxs)("div",{className:"row",children:[t.map(((e,t)=>(0,a.jsx)("div",{children:e},t))),(0,a.jsx)("div",{className:"faded",children:e})]},n)))})]}):null}));var ue=n(38894);const me=v.z.div`
  max-width: 60rem;
  overflow: hidden;
  text-overflow: ellipsis;
...
`,he=s.memo((function({children:e,className:t="",isHeader:n,isLeft:i,isOpen:r,isPadded:o,onClick:l,renderChildren:c,summary:d,summaryHead:u,summaryMeta:m,summarySub:h,withBreaks:p,withHidden:g}){const[f,b]=(0,ue.O)(r,l),x=(0,s.useMemo)((()=>f&&c&&c()),[f,c]),[v,w]=(0,s.useMemo)((()=>function(e){if(!e?.docs.length)return null;const t=e.docs.map((e=>e.toString().trim())),n=t.findIndex((e=>!e.length)),s=(i=(-1===n?t:t.slice(0,n)).join(" ").replace(/#(<weight>| <weight>).*<\/weight>/,"").replace(/\\/g,"").replace(/`/g,""),["[","]"].reduce(((e,t)=>function(e,t){return e.reduce(((e,n)=>n.split(t).reduce(((e,t)=>e.concat(t)),e)),[])}(e,t)),[i]));var i;return[s[0].split(/[.(]/)[0],(0,a.jsxs)(a.Fragment,{children:[s.map(((e,t)=>t%2?(0,a.jsxs)("em",{children:["[",e,"]"]},t):(0,a.jsx)("span",{children:e},t)))," "]})]}(m)||[h,h]),[m,h]),y=(0,s.useMemo)((()=>!!c||!!e&&(!Array.isArray(e)||0!==e.length)),[e,c]),j=(0,s.useMemo)((()=>(0,a.jsx)(A.Z,{color:y?void 0:"transparent",icon:f?"caret-up":"caret-down"})),[y,f]);return(0,a.jsxs)(me,{className:`${t} ui--Expander ${f?"isExpanded":""} ${n?"isHeader":""} ${o?"isPadded":""} ${y?"hasContent":""} ${p?"withBreaks":""}`,children:[(0,a.jsxs)("div",{className:"ui--Expander-summary"+(i?" isLeft":""),onClick:b,children:[i&&j,(0,a.jsxs)("div",{className:"ui--Expander-summary-header",children:[(0,a.jsx)("div",{className:"ui--Expander-summary-title",children:u}),d,w&&(0,a.jsx)("div",{className:"ui--Expander-summary-header-sub",children:f?w:v})]}),!i&&j]}),y&&(f||g)&&(0,a.jsx)("div",{className:"ui--Expander-content",children:e||x})]})})),pe=s.memo((function({className:e="",label:t,withEllipsis:n}){return(0,a.jsx)("label",{className:e,children:n?(0,a.jsx)("div",{className:"withEllipsis",children:t}):t})}));var ge=n(34814),fe=n(9118),be=n(74065),xe=n(86135),Ae=n(48731);const ve=s.memo((function({accountId:e,className:t="",extrinsic:n,icon:i,isBasic:r,isBusy:o,isDisabled:l,isIcon:c,isToplevel:d,isUnsigned:u,label:m,onClick:h,onFailed:p,onSendRef:g,onStart:b,onSuccess:x,onUpdate:A,params:v,tooltip:w,tx:y,withSpinner:j,withoutLink:C}){const{t:k}=(0,Z.$)(),N=(0,be.X)(),{queueExtrinsic:E}=(0,xe.L)(),[S,I]=(0,s.useState)(!1),[B,D]=(0,s.useState)(!1);(0,s.useEffect)((()=>{B&&b&&b()}),[B,b]);const L=(0,s.useCallback)((e=>{N.current&&I(!1),p&&p(e)}),[p,I,N]),V=(0,s.useCallback)((e=>{N.current&&I(!1),x&&x(e)}),[x,I,N]),P=(0,s.useCallback)((()=>{N.current&&D(!0)}),[D,N]),T=(0,s.useCallback)((()=>{let t;n?t=Array.isArray(n)?n:[n]:y&&(t=[y(...(0,f.m)(v)?v():v||[])]),(0,Ae.hu)(t?.length,"Expected generated extrinsic passed to TxButton"),N.current&&j&&I(!0),t.forEach((t=>{E({accountId:e?.toString(),extrinsic:t,isUnsigned:u,txFailedCb:j?L:p,txStartCb:P,txSuccessCb:j?V:x,txUpdateCb:A})})),h&&h()}),[L,P,V,e,u,h,p,x,A,v,n,E,I,y,j,N]);return g&&(g.current=T),(0,a.jsx)(J,{className:t,icon:i||"check",isBasic:r,isBusy:o,isDisabled:S||l||!u&&!e||!y&&(Array.isArray(n)?0===n.length:!n),isIcon:c,isToplevel:d,label:m||(c?"":k("Submit")),onClick:T,tooltip:w,withoutLink:C})})),we={transform:e=>e.isNone?0:e.unwrap().prior.length+1},ye=s.memo((function({className:e="",isPool:t,stakingInfo:n}){const{api:s}=(0,z.h)(),{allAccounts:i}=(0,ge.x)(),{t:r}=(0,Z.$)(),o=(0,fe.W7)(s.query.staking.slashingSpans,[n?.stashId],we);return n?.redeemable?.gtn(0)?(0,a.jsx)("div",{className:e,children:(0,a.jsx)(te.Z,{value:n.redeemable,children:i.includes((n.controllerId||"").toString())?(0,a.jsx)(ve,{accountId:n.controllerId,icon:"lock",isIcon:!0,params:t?[n.controllerId,o]:1===s.tx.staking.withdrawUnbonded.meta.args.length?[o]:[],tooltip:r("Withdraw these unbonded funds"),tx:t?s.tx.nominationPools.withdrawUnbonded:s.tx.staking.withdrawUnbonded},"unlock"):(0,a.jsx)("span",{className:"icon-void",children:" "})})}):null}));var je=n(48801),Ce=n.n(je);const ke=v.z.div`
  white-space: nowrap;
...
`,Ne=s.memo((function({className:e="",iconPosition:t="left",stakingInfo:n}){const{api:i}=(0,z.h)(),r=(0,fe.W7)(i.derive.session.progress),{t:o}=(0,Z.$)(),[l,c,d]=(0,s.useMemo)((()=>function(e,t){if(!e?.unlocking||!t)return[[],se.nw,!1];const n=t.eraProgress.gt(se.nw)&&t.eraProgress.gt(t.eraLength),a=e.unlocking.filter((({remainingEras:e,value:t})=>t.gt(se.nw)&&e.gt(se.nw))).map((e=>[e,e.remainingEras,e.remainingEras.sub(se.If).imul(t.eraLength).iadd(t.eraLength).isub(n?t.eraProgress.mod(t.eraLength):t.eraProgress)])),s=a.reduce(((e,[{value:t}])=>e.iadd(t)),new(Ce())(0));return[a,s,n]}(n,r)),[r,n]);if(!n||!l.length)return null;const u=`${n.accountId.toString()}-unlocking-trigger`;return(0,a.jsxs)(ke,{className:e,children:["left"===t&&(0,a.jsx)(A.Z,{className:"left",icon:"clock",tooltip:u}),(0,a.jsx)(te.Z,{value:c}),(0,a.jsx)(w.Z,{trigger:u,children:l.map((([{value:e},t,n],s)=>(0,a.jsxs)("div",{className:"row",children:[(0,a.jsx)("div",{children:o("Unbonding {{value}}",{replace:{value:(0,ie.a)(e,{forceUnit:"-"})}})}),(0,a.jsx)("div",{className:"faded",children:i.consts.babe?.epochDuration?(0,a.jsx)(ne.Z,{label:`${o("{{blocks}} blocks",{replace:{blocks:(0,p.u)(n)}})}, `,value:n}):o("{{eras}} eras remaining",{replace:{eras:(0,p.u)(t)}})}),d&&(0,a.jsx)("div",{className:"faded",children:o("Era is overdue for completion due to current network operating conditions")})]},s)))}),"right"===t&&(0,a.jsx)(A.Z,{className:"right",icon:"clock",tooltip:u})]})})),Ee={available:!0,bonded:!0,locked:!0,redeemable:!0,reserved:!0,total:!0,unlocking:!0,vested:!0},Se={crypto:!0,nonce:!0},Ie={unstakeThreshold:!0,validatorPayment:!0};function Be(){return(0,a.jsx)("span",{className:"icon-void",children:" "})}function De(e,t){const n=t.toHuman();try{return e[n]||n}catch{return n}}function Le({stakingInfo:e,withBalance:t=!0,withValidatorPrefs:n=!1}){if(e)return!0;if(!0===t||n)return!1;if((0,ae.K)(t)){if(t.unlocking||t.redeemable)return!1;if(t.bonded)return Array.isArray(t.bonded)}return!0}function Ve({address:e,balancesAll:t,withExtended:n},s){const i=!0===n?Se:n||void 0;return i?(0,a.jsxs)("div",{className:"column",children:[t&&i.nonce&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(pe,{label:s("transactions")}),(0,a.jsx)("div",{className:"result",children:(0,p.u)(t.accountNonce)})]}),i.crypto&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(pe,{label:s("type")}),(0,a.jsx)(oe,{accountId:e,className:"result"})]})]}):null}function Pe({stakingInfo:e,withValidatorPrefs:t=!1},n){const s=!0===t?Ie:t;return s&&e?.validatorPrefs?(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("div",{}),s.unstakeThreshold&&e.validatorPrefs.unstakeThreshold&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(pe,{label:n("unstake threshold")}),(0,a.jsx)("div",{className:"result",children:e.validatorPrefs.unstakeThreshold.toString()})]}),s.validatorPayment&&(e.validatorPrefs.commission||e.validatorPrefs.validatorPayment)&&(e.validatorPrefs.validatorPayment?(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(pe,{label:n("commission")}),(0,a.jsx)(te.Z,{className:"result",value:e.validatorPrefs.validatorPayment})]}):(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(pe,{label:n("commission")}),(0,a.jsxs)("span",{children:[(e.validatorPrefs.commission.unwrap().toNumber()/1e7).toFixed(2),"%"]})]}))]}):null}function Te(e,t,n,{address:i,balanceDisplay:r,balancesAll:o,bestNumber:l,convictionLocks:c,democracyLocks:d,isAllLocked:u,otherBonded:m,ownBonded:h,stakingInfo:g,votingOf:f,withBalanceToggle:b,withLabel:x}){const v=[],y=o;if(!b&&r.total&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(pe,{label:x?n("total"):""}),(0,a.jsx)(te.Z,{className:"result "+(o?"":"--tmp"),formatIndex:e,labelPost:(0,a.jsx)(Be,{}),value:o?o.freeBalance.add(o.reservedBalance):1})]},0)),o&&r.available&&y.availableBalance&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(pe,{label:n("transferrable")}),(0,a.jsx)(te.Z,{className:"result",formatIndex:e,labelPost:(0,a.jsx)(Be,{}),value:y.availableBalance})]},1)),l&&r.vested&&y?.isVesting){const t=y.vesting.filter((({endBlock:e})=>l.lt(e)));v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(pe,{label:n("vested")}),(0,a.jsx)(te.Z,{className:"result",formatIndex:e,labelPost:(0,a.jsx)(A.Z,{icon:"info-circle",tooltip:`${i}-vested-trigger`}),value:y.vestedBalance,children:(0,a.jsxs)(w.Z,{trigger:`${i}-vested-trigger`,children:[(0,a.jsxs)("div",{children:[(0,ie.a)(y.vestedClaimable,{forceUnit:"-"}),(0,a.jsx)("div",{className:"faded",children:n("available to be unlocked")})]}),t.map((({endBlock:e,locked:t,perBlock:s,vested:i},r)=>(0,a.jsxs)("div",{className:"inner",children:[(0,a.jsxs)("div",{children:[(0,ie.a)(i,{forceUnit:"-"}),(0,a.jsx)("div",{className:"faded",children:n("of {{locked}} vested",{replace:{locked:(0,ie.a)(t,{forceUnit:"-"})}})})]}),(0,a.jsxs)("div",{children:[(0,a.jsx)(ne.Z,{value:e.sub(l)}),(0,a.jsxs)("div",{className:"faded",children:[n("until block")," ",(0,p.u)(e)]})]}),(0,a.jsxs)("div",{children:[(0,ie.a)(s),(0,a.jsx)("div",{className:"faded",children:n("per block")})]})]},`item:${r}`)))]})})]},2))}const j=(y?.namedReserves||[]).reduce(((e,t)=>e.concat(...t)),[]),C=!!j&&0!==j.length;if(r.locked&&o&&(u||y.lockedBalance?.gtn(0))&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(pe,{label:n("locked")}),(0,a.jsx)(te.Z,{className:"result",formatIndex:e,labelPost:(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(A.Z,{icon:"info-circle",tooltip:`${i}-locks-trigger`}),(0,a.jsx)(w.Z,{trigger:`${i}-locks-trigger`,children:y.lockedBreakdown.map((({amount:e,id:s,reasons:i},r)=>(0,a.jsxs)("div",{className:"row",children:[e?.isMax()?n("everything"):(0,ie.a)(e,{forceUnit:"-"}),s&&(0,a.jsx)("div",{className:"faded",children:De(t,s)}),(0,a.jsx)("div",{className:"faded",children:i.toString()})]},r)))})]}),value:u?"all":y.lockedBalance})]},3)),r.reserved&&o?.reservedBalance?.gtn(0)&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(pe,{label:n("reserved")}),(0,a.jsx)(te.Z,{className:"result",formatIndex:e,labelPost:C?(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(A.Z,{icon:"info-circle",tooltip:`${i}-named-reserves-trigger`}),(0,a.jsx)(w.Z,{trigger:`${i}-named-reserves-trigger`,children:j.map((({amount:e,id:n},s)=>(0,a.jsxs)("div",{children:[(0,ie.a)(e,{forceUnit:"-"}),n&&(0,a.jsx)("div",{className:"faded",children:De(t,n)})]},s)))})]}):(0,a.jsx)(Be,{}),value:o.reservedBalance})]},4)),r.bonded&&(h.gtn(0)||0!==m.length)&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(pe,{label:n("bonded")}),(0,a.jsx)(te.Z,{className:"result",formatIndex:e,labelPost:(0,a.jsx)(Be,{}),value:h,children:0!==m.length&&(0,a.jsxs)(a.Fragment,{children:[" (+",m.map(((t,n)=>(0,a.jsx)(te.Z,{formatIndex:e,labelPost:(0,a.jsx)(Be,{}),value:t},n))),")"]})})]},5)),r.redeemable&&g?.redeemable?.gtn(0)&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(pe,{label:n("redeemable")}),(0,a.jsx)(ye,{className:"result",stakingInfo:g})]},6)),r.unlocking){if(g?.unlocking&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(pe,{label:n("unbonding")}),(0,a.jsx)("div",{className:"result",children:(0,a.jsx)(Ne,{iconPosition:"right",stakingInfo:g})})]},7)),d&&0!==d.length)v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(pe,{label:n("democracy")}),(0,a.jsx)("div",{className:"result",children:(0,a.jsx)(de,{value:d})})]},8));else if(l&&f&&f.isDirect){const{prior:[e,t]}=f.asDirect;t.gt(se.nw)&&e.gt(se.nw)&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(pe,{label:n("democracy")}),(0,a.jsx)("div",{className:"result",children:(0,a.jsx)(de,{value:[{balance:t,isFinished:l.gt(e),unlockAt:e}]})})]},8))}if(l&&c?.length){const e=c.reduce(((e,{total:t})=>(0,re.x)(e,t)),se.nw);v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(pe,{label:n("referenda")}),(0,a.jsx)(te.Z,{className:"result",labelPost:(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(A.Z,{icon:"clock",tooltip:`${i}-conviction-locks-trigger`}),(0,a.jsx)(w.Z,{trigger:`${i}-conviction-locks-trigger`,children:c.map((({endBlock:e,locked:t,refId:s,total:i},r)=>(0,a.jsxs)("div",{className:"row",children:[(0,a.jsxs)("div",{className:"nowrap",children:["#",s.toString()," ",(0,ie.a)(i,{forceUnit:"-"})," ",t]}),(0,a.jsx)("div",{className:"faded nowrap",children:e.eq(se.Ew)?n("ongoing referendum"):l.gte(e)?n("lock expired"):(0,a.jsxs)(a.Fragment,{children:[(0,p.u)(e.sub(l))," ",n("blocks"),", ",(0,a.jsx)(ne.Z,{isInline:!0,value:e.sub(l)})]})})]},r)))})]}),value:e})]},9))}}return o&&o.accountNonce&&r.nonce&&v.push((0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(pe,{label:n("transactions")}),(0,a.jsxs)("div",{className:"result",children:[(0,p.u)(o.accountNonce),(0,a.jsx)(Be,{})]})]},10)),b?(0,a.jsx)(s.Fragment,{children:(0,a.jsx)(he,{className:o?"":"isBlurred",summary:(0,a.jsx)(te.Z,{formatIndex:e,value:o?.freeBalance.add(o.reservedBalance)}),children:0!==v.length&&(0,a.jsx)("div",{className:"body column",children:v})})},e):(0,a.jsx)(s.Fragment,{children:v},e)}function Me(e,t,n,a){const{address:s,balancesAll:i,convictionLocks:r,democracyLocks:o,stakingInfo:l,votingOf:c,withBalance:d=!0,withBalanceToggle:u=!1,withLabel:m=!1}=e,h=!0===d?Ee:d||!1;if(!h)return[null];const[p,g]=function(e,t){let n=[],a=se.nw;return Array.isArray(t)?(n=t.filter(((e,t)=>0!==t)).filter((e=>e.gt(se.nw))),a=t[0]):e?.stakingLedger?.active&&e.accountId.eq(e.stashId)&&(a=e.stakingLedger.active.unwrap()),[a,n]}(l,h.bonded),f={address:s,balanceDisplay:h,bestNumber:n,convictionLocks:r,democracyLocks:o,isAllLocked:!!i&&i.lockedBreakdown.some((({amount:e})=>e?.isMax())),otherBonded:g,ownBonded:p,votingOf:c,withBalanceToggle:u,withLabel:m},b=[Te(0,t,a,{...f,balancesAll:i,stakingInfo:l})];return u&&i?.additional.length&&i.additional.forEach(((e,n)=>{b.push(Te(n+1,t,a,{...f,balancesAll:e}))})),b}const Fe=(0,_.withMulti)((0,v.z)((function(e){const{t}=(0,Z.$)(),n=(0,ee.C)(),{children:i,className:r="",extraInfo:o,withBalanceToggle:l,withHexSessionId:c}=e,d=(0,s.useRef)({democrac:t("via Democracy/Vote"),phrelect:t("via Council/Vote"),pyconvot:t("via Referenda/Vote"),"staking ":t("via Staking/Bond"),"vesting ":t("via Vesting")});return(0,a.jsxs)("div",{className:`${r} ui--AddressInfo ${l?"ui--AddressInfo-expander":""}`,children:[(0,a.jsxs)("div",{className:"column"+(l?" column--expander":""),children:[Me(e,d.current,n,t),c?.[0]&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(pe,{label:t("session keys")}),(0,a.jsx)("div",{className:"result",children:c[0]})]}),c&&c[0]!==c[1]&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(pe,{label:t("session next")}),(0,a.jsx)("div",{className:"result",children:c[1]})]}),Pe(e,t),o&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("div",{}),o.map((([e,t],n)=>(0,a.jsxs)(s.Fragment,{children:[(0,a.jsx)(pe,{label:e}),(0,a.jsx)("div",{className:"result",children:t})]},`label:${n}`)))]})]}),Ve(e,t),i&&(0,a.jsx)("div",{className:"column",children:i})]})}))`
  ...
  `,(0,_.withCalls)(["derive.balances.all",{paramName:"address",propName:"balancesAll",skipIf:function({withBalance:e=!0,withExtended:t=!1}){if(!0===e||!0===t)return!1;if((0,ae.K)(e)){if(e.available||e.locked||e.reserved||e.total||e.vested)return!1}else if((0,ae.K)(t)&&t.nonce)return!1;return!0}}],["derive.staking.account",{paramName:"address",propName:"stakingInfo",skipIf:Le}],["derive.democracy.locks",{paramName:"address",propName:"democracyLocks",skipIf:Le}],["query.democracy.votingOf",{paramName:"address",propName:"votingOf",skipIf:Le}])),ze={available:!0,bonded:!0,free:!0,locked:!0,reserved:!0,total:!0},Ze=v.z.section`
  .balanceExpander {
...
`,Re=s.memo((function({address:e,className:t}){const{t:n}=(0,Z.$)();return(0,a.jsxs)(Ze,{className:t,children:[(0,a.jsx)("div",{className:"ui--AddressMenu-sectionHeader",children:n("balance")}),(0,a.jsx)(Fe,{address:e,className:"balanceExpander",withBalance:ze,withLabel:!0},e)]})}));var $e=n(11677);const He=(0,$e.e)("useRegistrars",(function(e){const{api:t}=(0,z.h)(),{allAccounts:n,hasAccounts:a}=(0,ge.x)(),i=(0,fe.W7)(!e&&t.query.identity?.registrars);return(0,s.useMemo)((()=>{const e=(i||[]).map(((e,t)=>({address:e.isSome?e.unwrap().account.toString():null,index:t}))).filter((e=>!!e.address));return{isRegistrar:a&&e.some((({address:e})=>n.includes(e))),registrars:e}}),[n,a,i])}));var qe=n(19008),Ue=n(52953),Qe=n(74076),Oe=n(9652),We=n(48061),Ge=n(16039),Je=n(47025);function Ke(e){return!(!e||!e.toHuman)}const Ye=s.memo((function({className:e="",forceIconType:t,prefix:n,size:i=24,theme:r,value:o}){const{apiEndpoint:l,isEthereum:c,specName:d,systemName:u}=(0,z.h)(),{t:m}=(0,Z.$)(),{queueAction:h}=(0,xe.L)(),p=r||function(e,t,n){return"default"===Ge.X.icon&&(e?.ui?.identityIcon||(0,Oe.t)(t,n))||Ge.X.icon}(l,u,d),g="robohash"===p?Je.Z:void 0,f=(0,s.useCallback)((e=>h({account:e,action:m("clipboard"),message:m("address copied"),status:"queued"})),[h,m]);return(0,a.jsx)(We.ZP,{Custom:g,className:`ui--Identicon-React-Base ${e}`,onCopy:f,prefix:n,size:i,theme:t||(c?"ethereum":p),value:Ke(o)?o.toString():o})}));var Xe=n(36609);function _e({className:e="",label:t,value:n}){let s;if(Array.isArray(n)){const e=n.filter(((e,t)=>0!==t)),t=e.reduce(((e,t)=>e.add(t)),se.nw).gtn(0);t&&(s=e.map(((e,t)=>(0,a.jsx)(te.Z,{value:e},t))))}return(0,a.jsx)(te.Z,{className:`${e} ui--Balance`,label:t,value:Array.isArray(n)?n[0]:n,children:s&&(0,a.jsxs)("span",{children:[" (+",s,")"]})})}const et=s.memo((function(e){const{balance:t,className:n="",label:s,params:i}=e;return i?t?(0,a.jsx)(a.Fragment,{children:_e({className:n,label:s,value:t})}):(0,a.jsx)(Xe.Z,{className:`${n} ui--Balance`,label:s,params:i}):null})),tt={transform:e=>e.unwrapOr(null)},nt={transform:e=>e.unwrapOr(null)},at=s.memo((function({children:e,className:t="",label:n,params:s}){const{api:i}=(0,z.h)(),r=(0,fe.W7)(i.query.staking?.bonded,[s],tt),o=(0,fe.W7)(r&&i.query.staking?.ledger,[r],nt);return(0,a.jsx)(te.Z,{className:t,label:n,value:o?.active,children:e})})),st=s.memo((function(e){const{bonded:t,className:n="",label:s,params:i}=e;return i?t?(0,a.jsx)(a.Fragment,{children:_e({className:n,label:s,value:t})}):(0,a.jsx)(at,{className:`${n} ui--Bonded`,label:s,params:i}):null})),it=s.memo((function({children:e,className:t="",label:n,params:s}){const{api:i}=(0,z.h)(),r=(0,fe.W7)(i.derive.council.votesOf,[s]);return r?.stake.gtn(0)?(0,a.jsx)(te.Z,{className:t,label:n,value:r?.stake,children:e}):null})),rt=s.memo((function({className:e="",label:t,params:n}){return n?(0,a.jsx)(it,{className:`${e} ui--LockedVote`,label:t,params:n}):null})),ot=v.z.div`
  overflow-x: hidden;
...
`,lt=s.memo((function({balance:e,bonded:t,children:n,className:s="",iconInfo:i,isHighlight:r,isPadded:o=!0,label:l,labelBalance:c,nameExtra:d,onNameClick:u,summary:m,value:h,withAddress:p=!0,withBalance:g=!1,withBonded:f=!1,withLockedVote:b=!1,withName:x=!0,withShrink:A=!1,withSidebar:v=!0}){return h?(0,a.jsxs)(ot,{className:`${s} ui--AddressMini ${r?"isHighlight":""} ${o?"padded":""} ${A?"withShrink":""}`,children:[l&&(0,a.jsx)("label",{className:"ui--AddressMini-label",children:l}),(0,a.jsxs)("span",{className:"ui--AddressMini-icon",children:[(0,a.jsx)(Ye,{value:h}),i&&(0,a.jsx)("div",{className:"ui--AddressMini-icon-info",children:i})]}),(0,a.jsxs)("span",{className:"ui--AddressMini-info",children:[p&&(0,a.jsx)("span",{className:"ui--AddressMini-address",onClick:u,children:x?(0,a.jsx)(T,{value:h,withSidebar:v,children:d}):(0,a.jsx)("span",{className:"shortAddress",children:h.toString()})}),n]}),(0,a.jsxs)("div",{className:"ui--AddressMini-balances",children:[g&&(0,a.jsx)(et,{balance:e,label:c,params:h}),f&&(0,a.jsx)(st,{bonded:t,label:"",params:h}),b&&(0,a.jsx)(rt,{params:h}),m&&(0,a.jsx)("div",{className:"ui--AddressMini-summary",children:m})]})]}):null})),ct=v.z.div`
  & {
    display: flex;
    align-items: center;
...
`,dt=s.memo((function({children:e,className:t="",icon:n,isBig:s,subtitle:i,title:r}){return(0,a.jsxs)(ct,{className:["ui--AvatarItem",t,s&&"big"].join(" "),children:[(0,a.jsx)("div",{className:"ui--AvatarItem-icon",children:n}),(0,a.jsxs)("div",{className:"ui--AvatarItem-details",children:[(0,a.jsx)("div",{className:"ui--AvatarItem-title",children:r}),(0,a.jsx)("div",{className:"ui--AvatarItem-subtitle",children:i})]}),e]})})),ut=v.z.a`
  .ui--Icon {
    margin-right: 0.5em;
  }
`,mt=s.memo((function({className:e="",href:t,icon:n,label:s,onClick:i,rel:r,target:o}){return(0,a.jsxs)(ut,{className:e,href:t,onClick:i,rel:r,target:o,children:[n&&(0,a.jsx)(A.Z,{icon:n}),s]})}));const ht=e=>e.filter((([,e])=>!e.isFeePaid)),pt=e=>e.filter((([,e])=>e.isKnownGood)),gt=e=>e.filter((([,e])=>e.isReasonable)),ft=e=>e.filter((([,e])=>e.isErroneous)),bt=e=>e.filter((([,e])=>e.isLowQuality));const xt=(0,$e.e)("useJudgements",(function(e){const{identity:t}=(0,M.B)(e),{registrars:n}=He(),a=(0,s.useMemo)((()=>function(e){if(!e)return[];const t=function(e){const t=ht(e),n=pt(t),a=gt(t);return{Erroneous:ft(t),"Known good":n,"Low quality":bt(t),Reasonable:a}}(e.judgements),n=[];for(const e in t){const s=e;0!==t[s].length&&n.push({judgementName:s,registrarsIndexes:(a=t[s],a.map((e=>e[0])))})}var a;return n}(t)),[t]);return(0,s.useMemo)((()=>function(e,t){return e.map((({judgementName:e,registrarsIndexes:n})=>({judgementName:e,registrars:n.map((e=>(e=>t.find((t=>t.index===e)))(e.toNumber())))})))}(a,n)),[n,a])}));var At=n(17608);const vt=v.z.div`
  align-items: center;
  color: #8B8B8B;
  var(--font-size-small);
  display: flex;
...
`,wt=s.memo((function({address:e,className:t}){return(0,a.jsxs)(vt,{className:t,"data-testid":"parent",children:[(0,a.jsx)(A.Z,{className:"parent-icon",icon:"code-branch"}),(0,a.jsx)(T,{value:e,withSidebar:!0})]})})),yt=v.z.div`
  overflow-x: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
`,kt=s.memo((function({className:e=""}){return(0,a.jsx)(Ct,{className:`${e} ui--Menu__Divider`})})),Nt=v.z.div`
  color: var(--color-label);
  font-size: var(--font-size-tiny);
  line-height: 0.857rem;
  margin-bottom: 0.3rem;
`,Et=s.memo((function({children:e,className:t}){return(0,a.jsx)(Nt,{className:t,children:e})})),St=v.z.div`
  align-items: center;
  cursor: pointer;
  display: flex;
  flex-direction: row;
...
`,It=s.memo((function({children:e,className:t="",icon:n,isDisabled:i,label:r,onClick:o}){const l=(0,s.useCallback)((()=>{!i&&o&&Promise.resolve(o()).catch(console.error)}),[i,o]);return(0,a.jsxs)(St,{className:`${t} ui--Menu__Item ${n?"hasIcon":""} ${i?"isDisabled":""}`,onClick:l,children:[n&&(0,a.jsx)(A.Z,{color:"darkGray",icon:n}),r,e]})})),Bt=v.z.div`
  display: flex;
  flex-direction: column;
  min-width: 14.286rem;
  margin: 1rem 0;
...
`,Dt=s.memo((function({children:e,className:t=""}){return(0,a.jsx)(Bt,{className:`${t} ui--Menu`,children:e})}));Dt.Divider=kt,Dt.Item=It,Dt.Header=Et;const Lt=Dt,Vt=(0,$e.e)("useOutsideClick",(function(e,t){const n=(0,s.useCallback)((n=>{e.length&&!function(e,t){return e.some((e=>e.current&&e.current.contains(t.target)))}(e,n)&&t()}),[e,t]);(0,s.useEffect)((()=>(document.addEventListener("click",n,!0),()=>{document.removeEventListener("click",n,!0)})),[n,t])}));var Pt=n(28316);const Tt=14*.8;function Mt(e,t){return"left"===t?e-Tt:"right"===t?Tt:e/2}function Ft(e,t,n,a,s){const{height:i,y:r}=t;return"bottom"===e?a.height-i-r-14>n:s<56?r-(56-s)>n:r>n}function zt(e,t,n){return"bottom"===t?e/2:-1*(e/2+n+Tt)}function Zt(e,t,n,a){return"bottom"===t?e+n.height-a-14:e<56?56:e}const Rt=(0,$e.e)("useScroll",(function(){const[e,t]=(0,s.useState)(window.scrollY),n=(0,s.useCallback)((()=>t(window.scrollY)),[]);return(0,s.useEffect)((()=>(window.addEventListener("scroll",n),()=>{window.removeEventListener("scroll",n)})),[n]),e}));var $t=n(91012);const Ht=(0,$e.e)("useWindowSize",(function(){return(0,s.useContext)($t.d)})),qt=(0,$e.e)("useElementPosition",(function(e){const[t,n]=(0,s.useState)(),a=(0,be.X)(),i=Ht(),r=Rt();return(0,s.useEffect)((()=>{if(a.current&&e?.current){const{height:t,width:a,x:s,y:i}=e.current.getBoundingClientRect();n({height:t,width:a,x:s,y:i})}}),[a,e,r,i]),t})),Ut={x:0,y:0},Qt=(0,$e.e)("usePopupWindow",(function(e,t,n){const[a,i]=(0,s.useState)(Ut),[r,o]=(0,s.useState)("top"),l=qt(e),c=qt(t),d=Rt(),u=Ht();return(0,s.useEffect)((()=>{u&&c&&o(c.y>u.height/2?"top":"bottom")}),[c,u]),(0,s.useEffect)((()=>{l&&c&&i(function(e,t,n,a,s,i){const r=e.x+e.width/2,o=e.y+s+e.height/2;return{x:r-Mt(a.width,t),y:Ft(n,e,a.height,i,s)?o+zt(e.height,n,a.height):Zt(s,n,i,a.height)}}(c,n,r,l,d,u))}),[n,d,c,r,l,u]),(0,s.useMemo)((()=>({pointerStyle:r,renderCoords:a})),[a,r])})),Ot=v.z.div`
...
`,Wt=s.memo((function({children:e,className:t="",position:n,triggerRef:s,windowRef:i}){const{pointerStyle:r,renderCoords:{x:o,y:l}}=Qt(i,s,n);return(0,Pt.createPortal)((0,a.jsx)(Ot,{className:`${t} ${r}Pointer ${n}Position`,"data-testid":"popup-window",ref:i,style:o&&l&&{transform:`translate3d(${o}px, ${l}px, 0)`,zIndex:1e3}||void 0,children:e}),document.body)})),Gt=v.z.div`
  display: inline-flex;
  flex-direction: column;
  justify-content: center;
  position: relative;
`,Jt=s.memo((function({children:e,className:t="",closeOnScroll:n,isDisabled:i,onCloseAction:r,position:o="left",value:l}){const{themeClassName:c}=(0,x.F)(),[d,u,m]=(0,ue.O)(!1),h=(0,s.useRef)(null),p=(0,s.useRef)(null),g=(0,s.useCallback)((()=>m(!1)),[m]),f=(0,s.useMemo)((()=>[h,p]),[h,p]);return Vt(f,g),(0,s.useEffect)((()=>(n&&document.addEventListener("scroll",g,!0),()=>document.removeEventListener("scroll",g,!0))),[n,g,m]),(0,s.useEffect)((()=>{!d&&r&&r()}),[d,r]),(0,a.jsxs)(Gt,{className:`${t} ui--Popup ${c}`,children:[d&&(0,a.jsx)(Wt,{position:o,triggerRef:h,windowRef:p,children:l}),(0,a.jsx)("div",{"data-testid":"popup-open",onClick:u,ref:h,children:e??(0,a.jsx)(J,{className:d?"isOpen":"",icon:"ellipsis-v",isDisabled:i,isReadOnly:!1})})]})})),Kt=s.memo((function({judgement:{judgementName:e,registrars:t}}){const n=(0,s.useMemo)((()=>{return"Erroneous"===(t=e)||"Low quality"===t?"red":"green";var t}),[e]);return(0,a.jsx)(Jt,{closeOnScroll:!0,position:"middle",value:(0,a.jsx)(Lt,{children:t.map((e=>e&&(0,a.jsx)(jt,{value:e.address},e.address)))}),children:(0,a.jsx)(At.Z,{color:n,label:`${t.length} ${e}`,size:"tiny"})})})),Yt=v.z.div`
  margin-top: 0.714rem;
...
`,Hn=s.memo((function({children:e,className:t=""}){return(0,a.jsx)($n,{className:`${t} ui--Modal-Actions`,children:(0,a.jsx)(J.Group,{children:e})})})),qn=v.z.div`
  align-items: center;
  display: flex;
  justify-content: space-between;
...
`,Un=s.memo((function({align:e="left",children:t,className:n="",hint:s}){return(0,a.jsxs)(qn,{className:`${n} ui--Modal-Columns ${e}Align`,children:[(0,a.jsx)("div",{className:"ui--Modal-Columns-content",children:t}),s&&(0,a.jsx)("div",{className:"ui--Modal-Columns-hint",children:s})]})})),Qn=v.z.div`
  padding: 1.5rem;
`,On=s.memo((function({children:e,className:t=""}){return(0,a.jsx)(Qn,{className:`${t} ui--Modal-Content`,children:e})})),Wn=v.z.div`
  display: flex;
  justify-content: space-between;
  padding: 0.75rem 1.5rem 0;
`,Gn=s.memo((function({className:e="",header:t,onClose:n}){return(0,a.jsxs)(Wn,{className:`${e} ui--Modal-Header`,children:[t&&(0,a.jsx)("h1",{children:t}),(0,a.jsx)(J,{dataTestId:"close-modal",icon:"times",onClick:n})]})})),Jn=Fn.vJ`
  body {
    overflow: hidden;
  }
`,Kn=v.z.div`
...
`,ba=s.memo((function({className:e="",flags:t,isEditing:n,isEditingName:i,onCancel:r,onForgetAddress:o,onSaveName:l,onSaveTags:c,onUpdateName:d,recipientId:u,toggleIsEditingName:m,toggleIsEditingTags:h}){const{t:p}=(0,Z.$)(),[g,b]=(0,ue.O)(),x=(0,z.h)(),A=(0,s.useCallback)((()=>{o(),d&&d()}),[o,d]),v=(0,s.useCallback)((()=>{t.isEditable&&m(),h()}),[t.isEditable,m,h]),w=(0,s.useCallback)((()=>{l(),d&&d()}),[l,d]),y=(0,s.useCallback)((()=>{i&&(t.isInContacts||t.isOwned)&&(w(),m())}),[i,t.isInContacts,t.isOwned,w,m]),j=(0,s.useCallback)((()=>{n&&(y(),c()),v()}),[n,v,y,c]);return(0,a.jsxs)(fa,{className:`${e} ui--AddressMenu-buttons`,children:[n?(0,a.jsxs)(J.Group,{children:[(0,a.jsx)(J,{icon:"times",label:p("Cancel"),onClick:r}),(0,a.jsx)(J,{icon:"save",label:p("Save"),onClick:j})]}):(0,a.jsxs)(J.Group,{children:[((0,f.m)(x.api.tx.balances?.transferAllowDeath)||(0,f.m)(x.api.tx.balances?.transfer))&&(0,a.jsx)(J,{icon:"paper-plane",isDisabled:n,label:p("Send"),onClick:b}),!t.isOwned&&!t.isInContacts&&(0,a.jsx)(J,{icon:"plus",isDisabled:n,label:p("Save"),onClick:w}),!t.isOwned&&t.isInContacts&&(0,a.jsx)(J,{icon:"ban",isDisabled:n,label:p("Remove"),onClick:A}),(0,a.jsx)(J,{icon:"edit",isDisabled:!t.isEditable,label:p("Edit"),onClick:j})]}),g&&(0,a.jsx)(ga,{onClose:b,recipientId:u},"modal-transfer")]})})),xa=s.memo((function({accountIndex:e,defaultValue:t,editingName:n,flags:s,onChange:i,value:r}){const{t:o}=(0,Z.$)(),[l,c]=(0,ue.O)(),d=()=>{};return(0,a.jsxs)("div",{className:"ui--AddressSection",children:[(0,a.jsx)(Ye,{size:80,value:r}),(0,a.jsxs)("div",{className:"ui--AddressSection__AddressColumn",children:[(0,a.jsx)(T,{override:n?(0,a.jsx)(en.ZP,{className:"name--input",defaultValue:t,label:"name-input",onChange:i,withLabel:!1}):s.isEditable?t.toUpperCase()||o("<unknown>"):void 0,value:r,withSidebar:!1}),(0,a.jsx)("div",{className:"ui--AddressMenu-addr",children:r}),e&&(0,a.jsxs)("div",{className:"ui--AddressMenu-index",children:[(0,a.jsxs)("label",{children:[o("index"),":"]})," ",e]})]}),(0,a.jsx)("div",{className:"ui--AddressSection__CopyColumn",children:(0,a.jsx)("div",{className:"ui--AddressMenu-copyaddr",children:(0,a.jsx)(dn(),{text:r,children:(0,a.jsx)("span",{children:(0,a.jsx)(J.Group,{children:(0,a.jsx)(J,{icon:l?"check":"copy",label:o(l?"Copied":"Copy"),onClick:l?d:c,onMouseLeave:l?c:d})})})})})})]})})),Aa=(0,v.z)(At.Z)`
...
`,Va=s.memo((function({address:e,className:t="",filter:n,isHidden:i,noToggle:o,onChange:l,value:c}){const{api:d}=(0,z.h)(),u=(0,r.Y)(e),m=(0,s.useMemo)((()=>!u||(0,b.r7)(d,e,u,n,!1)),[d,e,n,u]),h=(0,s.useCallback)((()=>l&&l(!c)),[l,c]);return(0,a.jsxs)(La,{className:`${t} ui--AddressToggle ${c||o?"isAye":"isNay"} ${i||!m?"isHidden":""}`,onClick:h,children:[(0,a.jsx)(lt,{className:"ui--AddressToggle-address",value:e,withSidebar:!1}),!o&&(0,a.jsx)("div",{className:"ui--AddressToggle-toggle",children:(0,a.jsx)(ha,{label:"",value:c})})]})}));var Pa=n(84522);const Ta=v.z.img`${"\n  background: white;\n  border-radius: 50%;\n  box-sizing: border-box;\n  color: #333;\n\n  &.isInline {\n    display: inline-block;\n    height: 24px;\n    margin-right: 0.75rem;\n    vertical-align: middle;\n    width: 24px;\n  }\n"}`,Ma=s.memo((function({className:e="",isInline:t,logo:n,onClick:i,withoutHl:r}){const o=(0,s.useMemo)((()=>{const e=n||Pa.h;return e&&"empty"!==e&&(e.startsWith("data:")||e.startsWith("fa;"))?e.startsWith("fa;")?e.substring(3):e:Pa.h}),[n]),l=`${e} ui--ChainImg ${n||r?"":"highlight--bg"} ${t?"isInline":""}`;return(0,a.jsx)(Ta,{alt:"chain logo",className:l,onClick:i,src:o})})),Fa=s.memo((function({className:e="",label:t,params:n}){return n?(0,a.jsx)(oa.Z,{className:`${e} ui--Available`,label:t,params:n}):null})),za=s.memo((function(){const{t:e}=(0,Z.$)(),{api:t}=(0,z.h)();return(0,f.m)(t.tx.utility.batchAll)?null:(0,a.jsx)(ua,{content:e("This chain does not yet support atomic batch operations. This means that if the transaction gets executed and one of the operations do fail (due to invalid data or lack of available funds) some of the changes made may not be applied.")})}));s.memo((function({className:e="",isDisabled:t,label:n,onClick:s,tabIndex:i}){const{t:r}=(0,Z.$)();return(0,a.jsx)(J,{className:e,icon:"times",isDisabled:t,label:n||r("Cancel"),onClick:s,tabIndex:i})}));const Za=v.z.article`
  position: relative;
  flex: 1 1;
  min-width: 24%;
  justify-content: space-around;
...
`,Ra=s.memo((function({children:e,className:t="",isError:n,isSuccess:s,withBottomMargin:i}){return(0,a.jsx)(Za,{className:`${t} ui--Card ${n&&!s?"error":""} ${!n&&s?"success":""} ${i?"withBottomMargin":""}`,children:e})}));var $a=n(12372);const Ha=s.memo((function({angle:e,type:t}){return(0,a.jsx)("div",{className:`clip ${t}`,children:(0,a.jsx)("div",{className:"highlight--bg",style:{transform:`rotate(${e}deg)`}})})})),qa="3.5rem",Ua=v.z.div`
  border-radius: 100%;
  clip-path: circle(50%);
  height: ${qa};
  position: relative;
...
`,Qa=s.memo((function({className:e="",isBlurred:t,isDisabled:n,total:s,value:i}){const r=(0,$a.G)(s||0),o=r.gtn(0)?(0,$a.G)(i||0).muln(36e3).div(r).toNumber()/100:0;if(o<0)return null;const l=360===o?360:o%360;return(0,a.jsxs)(Ua,{className:`${e} ui--Progress ${n?"isDisabled":""} ${t?"--tmp":""}`,children:[(0,a.jsx)("div",{className:"background highlight--bg"}),(0,a.jsx)(Ha,{angle:l<=180?l.toFixed(1):"180",type:"first"}),(0,a.jsx)(Ha,{angle:l<=180?"0":(l-180).toFixed(1),type:"second"}),(0,a.jsx)("div",{className:"inner",children:(0,a.jsxs)("div",{children:[Math.floor(100*o/360),"%"]})})]})})),Oa=v.z.article`
  align-items: center;
...
`,ws=s.memo((function({className:e="",isDisabled:t,label:n,onChange:i,value:r}){const o=(0,s.useCallback)((()=>{!t&&i&&i(!r)}),[t,i,r]);return(0,a.jsxs)(vs,{className:`${e} ui--Checkbox ${t?"isDisabled":""}`,onClick:o,children:[(0,a.jsx)(A.Z,{color:r?"normal":"transparent",icon:"check"}),n&&(0,a.jsx)("label",{children:n})]})})),ys="750px",js="550px",Cs="\n  display: flex;\n  flex-wrap: wrap;\n\n  &.is50 {\n    > .ui--Column {\n      max-width: 50%;\n      min-width: 50%;\n    }\n  }\n\n  &.is60 {\n    > .ui--Column:first-child {\n      max-width: 60%;\n      min-width: 60%;\n    }\n\n    > .ui--Column:last-child {\n      max-width: 40%;\n      min-width: 40%;\n    }\n  }\n\n  &.is100 {\n    > .ui--Column {\n      max-width: 100%;\n      min-width: 100%;\n    }\n  }\n",ks=v.z.div`
  &.isReverse {
...
`,Ds=s.memo((function({className:e="",code:t,isValid:n,onEdit:i}){const[r]=(0,s.useState)((()=>`flask-${Date.now()}`)),o=(0,s.useRef)(null);return(0,s.useEffect)((()=>{const e=new Is.Z(`#${r}`,{language:"js",lineNumbers:!0});e.updateCode(t),e.editorRoot.addEventListener("keydown",(()=>{e.onUpdate(i)})),o.current=e}),[]),(0,s.useEffect)((()=>{o.current&&o.current.updateCode(t)}),[t]),(0,a.jsx)(Bs,{className:`${e} ui-Editor ${!1===n?"invalid":""}`,id:r})})),Ls=v.z.div`
  ...
  border-radius: 4px;
  cursor: pointer;
`,Vs=s.memo((function({className:e="",expanded:t,onClick:n}){return(0,a.jsx)(Ls,{className:`${e} ui--ExpandButton`,"data-testid":"row-toggle",onClick:n,children:(0,a.jsx)(A.Z,{icon:t?"caret-up":"caret-down"})})}));var Ps=n(27421);const Ts=(0,$e.e)("useWindowColumns",(function(e=3){const t=Ht();return(0,Ps.N)(e>=3&&t.width>=1500?3:e>=2&&t.width>=1050?2:1)})),Ms=s.memo((function({children:e,className:t="",colSpan:n,label:s,labelPost:i,rowSpan:r,value:o,withLoading:l}){return(0,a.jsxs)("td",{className:`${t} ui--Table-Column-Balance number`,colSpan:n,rowSpan:r,children:[o?(0,a.jsx)(te.Z,{label:s,labelPost:i,value:o}):l&&(0,a.jsx)(te.Z,{className:"--tmp",value:1}),e]})})),Fs=v.z.td`
  && {
    box-sizing: content-box;
    cursor: pointer;
    min-width: 1.7rem;
...
`,zs=s.memo((function({className:e="",colSpan:t,isExpanded:n,rowSpan:s,toggle:i}){return(0,a.jsx)(Fs,{className:`${e} ui--Table-Column-Expand`,colSpan:t,onClick:i,rowSpan:s,children:(0,a.jsx)("div",{children:(0,a.jsx)(A.Z,{icon:n?"caret-up":"caret-down"})})})})),Zs=v.z.td`
  && {
    box-sizing: content-box;
    cursor: pointer;
    min-width: 1rem;
...
`,Rs=s.memo((function({address:e,className:t="",colSpan:n,isFavorite:i,rowSpan:r,toggle:o}){const l=(0,s.useCallback)((()=>o(e)),[e,o]);return(0,a.jsx)(Zs,{className:`${t} ui--Table-Column-Favorite`,colSpan:n,onClick:l,rowSpan:r,children:(0,a.jsx)(A.Z,{color:i?"orange":"gray",icon:"star"})})})),$s=`${7.15.toFixed(3)}ch`,Hs=v.z.td`
  && {
    box-sizing: content-box;
    min-width: ${$s};
    text-align: right;
...
`,Js=s.memo((function({className:e="",footer:t,isEmpty:n}){return!t||n?null:(0,a.jsx)(Gs,{className:`${e} ui--Table-Foot`,children:t})})),Ks=v.z.thead`
  z-index: 1;
...
`,ai=s.memo((function({children:e,className:t="",empty:n,emptySpinner:s,filter:i,footer:r,header:o,headerChildren:l,isFixed:c,isInline:d,isSplit:u,legend:m,maxColumns:h,noBodyTag:p}){const g=Ts(h),f=Array.isArray(e),b=!e||f&&0===e.length,x=(0,a.jsx)(Ys,{filter:i,header:o,isEmpty:b,children:l});return u&&f&&!b&&1!==g?(0,a.jsxs)(ni,{className:`${t} ui--Table isSplit`,children:[m,(0,a.jsx)("table",{className:"noMargin",children:x}),(0,a.jsx)("div",{className:"ui--Table-Split",children:Xs[g].map((t=>(0,a.jsx)("div",{className:`ui--Table-Split-${g}`,children:(0,a.jsx)("table",{className:"noMargin",children:(0,a.jsx)("tbody",{className:"ui--Table-Body",children:e.filter(((e,n)=>n%g===t))})})},t)))})]}):(0,a.jsxs)(ni,{className:`${t} ui--Table`,children:[m,(0,a.jsxs)("table",{className:`${c&&!b?"isFixed":"isNotFixed"} ${d?"isInline":""}`,children:[x,(0,a.jsx)(Ws,{empty:n,emptySpinner:s,isEmpty:b,noBodyTag:p,children:e}),(0,a.jsx)(Js,{footer:r,isEmpty:b})]})]})}));ai.Column=Qs,ai.Row=Os;const si=ai;function ii(e,t){return(0,a.jsx)("tr",{children:(0,a.jsx)("td",{children:e})},t)}const ri=(0,v.z)(he)`
  .tableContainer {
    overflow-y: scroll;
    display: block;
    margin: 0 0 0 auto;
...
`,ci=s.memo((function({className:e="",filterOn:t,label:n,setFilter:s}){return(0,a.jsx)(li,{className:e,children:(0,a.jsx)(en.ZP,{autoFocus:!0,isFull:!0,label:n,onChange:s,value:t})})})),di=v.z.div`
  display: none;
...
`;s.memo((function({className:e="",md:t}){const[n,s]=(0,ue.O)();return(0,a.jsxs)(xi,{className:`${e} ui--HelpOverlay`,children:[(0,a.jsx)("div",{className:"help-button",children:(0,a.jsx)(A.Z,{icon:"question-circle",onClick:s})}),(0,a.jsxs)("div",{className:"help-slideout "+(n?"open":"closed"),children:[(0,a.jsx)("div",{className:"help-button",children:(0,a.jsx)(A.Z,{icon:"times",onClick:s})}),(0,a.jsx)(fi.U,{className:"help-content",rehypePlugins:bi,children:t})]})]})}));const Ai=(0,v.z)(gn.Z)`
  background: white;
...
`,vi=s.memo((function({children:e,className:t="",type:n="info"}){return(0,a.jsx)(Ai,{children:(0,a.jsx)("div",{className:`${t} ${n}`,children:e})})}));var wi=n(47623);const yi=s.memo((function({address:e,filter:t,isHidden:n,onSelect:i}){const r=(0,s.useCallback)((()=>i(e)),[e,i]);return n?null:(0,a.jsx)(Va,{address:e,filter:t,noToggle:!0,onChange:r})})),ji=s.memo((function({address:e,filter:t,isHidden:n,onDeselect:i}){const r=(0,s.useCallback)((()=>i(e)),[e,i]);return n?null:(0,a.jsx)(Va,{address:e,filter:t,noToggle:!0,onChange:r})})),Ci=v.z.div`
...
`,ki=s.memo((function({available:e,availableLabel:t,className:n="",defaultValue:i,maxCount:r,onChange:o,valueLabel:l}){const{t:c}=(0,Z.$)(),[d,u]=(0,s.useState)(""),[m,h]=(0,s.useState)([]),p=(0,Ps.N)(d),g=(0,wi.q)();(0,s.useEffect)((()=>{i&&h(i)}),[i]),(0,s.useEffect)((()=>{m&&o(m)}),[o,m]);const f=(0,s.useCallback)((e=>h((t=>function(e,t,n){return!e.includes(t)&&e.length<n?e.concat(t):e}(t,e,r)))),[r]),b=(0,s.useCallback)((e=>h((t=>function(e,t){return e.includes(t)?e.filter((e=>e!==t)):e}(t,e)))),[]);return(0,a.jsxs)(Ci,{className:`${n} ui--InputAddressMulti`,children:[(0,a.jsx)(en.ZP,{autoFocus:!0,className:"ui--InputAddressMulti-Input",isSmall:!0,onChange:u,placeholder:c("filter by name, address, or account index"),value:d,withLabel:!1}),(0,a.jsxs)("div",{className:"ui--InputAddressMulti-columns",children:[(0,a.jsxs)("div",{className:"ui--InputAddressMulti-column",children:[(0,a.jsx)("label",{children:l}),(0,a.jsx)("div",{className:"ui--InputAddressMulti-items",children:m.map((e=>(0,a.jsx)(ji,{address:e,onDeselect:b},e)))})]}),(0,a.jsxs)("div",{className:"ui--InputAddressMulti-column",children:[(0,a.jsx)("label",{children:t}),(0,a.jsx)("div",{className:"ui--InputAddressMulti-items",children:g?e.map((e=>(0,a.jsx)(yi,{address:e,filter:p,isHidden:m?.includes(e),onSelect:f},e))):(0,a.jsx)(U,{})})]})]})]})})),Ni=v.z.div`
  position: relative;
...
`,_i=s.memo((function({accept:e,className:t="",clearContent:n,isDisabled:i,isError:r=!1,isFull:o,label:l,labelExtra:c,onChange:d,placeholder:u,withEllipsis:m,withLabel:h}){const{t:g}=(0,Z.$)(),f=(0,s.createRef)(),[b,x]=(0,s.useState)(),A=(0,s.useCallback)((e=>{e.forEach((e=>{const t=new FileReader;t.onabort=Yi,t.onerror=Yi,t.onload=({target:t})=>{if(t?.result){const n=e.name,a=function(e){const t=new Uint8Array(e);if(t[0]===Ji&&t[1]===Ki){let e=(0,Wi.z)(t);for(;e.endsWith("\n");)e=e.substring(0,e.length-1);if((0,Qe.vq)(e))return(0,Gi.G)(e)}return t}(t.result);d&&d(a,n),f&&x({name:n,size:a.length})}},t.readAsArrayBuffer(e)}))}),[f,d]),{getInputProps:v,getRootProps:w}=(0,Oi.uI)({accept:e?.reduce(((e,t)=>({...e,[t]:[]})),{}),disabled:i,onDrop:A}),y=(0,a.jsxs)(Xi,{...w({className:`${t} ui--InputFile ${r?"error":""}`}),children:[(0,a.jsx)("input",{...v()}),(0,a.jsx)("em",{className:"label",children:!b||n?u||g("click to select or drag and drop the file here"):u||g("{{name}} ({{size}} bytes)",{replace:{name:b.name,size:(0,p.u)(b.size)}})})]});return l?(0,a.jsx)(gn.Z,{isFull:o,label:l,labelExtra:c,withEllipsis:m,withLabel:h,children:y}):y}));var er=n(39764);function tr(e,t,n){const s=t[n];return s&&0!==Object.keys(e.rpc[n]).length?Object.keys(e.rpc[n]).filter((e=>!e.startsWith("$"))).sort().map((e=>s[e])).filter((e=>!!e)).filter((({isSubscription:e})=>!e)).map((({description:e,method:t,params:s})=>{const i=s.map((({name:e})=>e)).join(", ");return{className:"ui--DropdownLinked-Item",key:`${n}_${t}`,text:[(0,a.jsxs)("div",{className:"ui--DropdownLinked-Item-call",children:[t,"(",i,")"]},`${n}_${t}:call`),(0,a.jsx)("div",{className:"ui--DropdownLinked-Item-text",children:e||t},`${n}_${t}:text`)],value:t}})):[]}var nr=n(13529),ar=n(85617);const sr=(0,$e.e)("useRpcs",(function(){const{api:e}=(0,z.h)();return(0,s.useMemo)((()=>function(e,t,{specName:n}){return Object.entries((0,ar.KM)(e,t,n)).reduce(((e,[t,n])=>(e[t]??=function(e,t){return Object.entries(t).reduce(((t,[n,a])=>(t[n]={isSubscription:!1,jsonrpc:`${e}_${n}`,method:n,section:e,...a},t)),{})}(t,n),e)),{...nr.Z})}(e.registry,e.runtimeChain,e.runtimeVersion)),[e])})),ir=s.memo((function({className:e="",isError:t,onChange:n,options:i,value:r}){const o=sr(),l=(0,s.useCallback)((e=>o[r.section][e]),[o,r]);return i.length?(0,a.jsx)(_t.Z,{className:`${e} ui--DropdownLinked-Items`,isError:t,onChange:n,options:i,transform:l,value:r.method,withLabel:!1}):null})),rr=s.memo((function({className:e="",defaultValue:t,isError:n,onChange:s,options:i,value:r}){return(0,a.jsx)(_t.Z,{className:`${e} ui--DropdownLinked-Sections`,defaultValue:t,isError:n,onChange:s,options:i,value:r.section,withLabel:!1})})),or=s.memo((function({className:e="",defaultValue:t,label:n,onChange:i,withLabel:r}){const{api:o}=(0,z.h)(),l=sr(),[c,d]=(0,s.useState)((()=>tr(o,l,t.section))),[u]=(0,s.useState)((()=>function(e){return Object.keys(e.rpc).filter((e=>!e.startsWith("$"))).sort().filter((t=>0!==Object.keys(e.rpc[t]).length)).map((e=>({text:e,value:e})))}(o))),[m,h]=(0,s.useState)((()=>t));(0,s.useEffect)((()=>{i&&i(m)}),[i,m]);const p=(0,s.useCallback)((e=>{m!==e&&h((()=>e))}),[m]),g=(0,s.useCallback)((e=>{if(e!==m.section){const t=tr(o,l,e);d(t),p(l[e][t[0].value])}}),[p,o,l,m]);return(0,a.jsxs)(Ii,{className:e,label:n,withLabel:r,children:[(0,a.jsx)(rr,{className:"small",onChange:g,options:u,value:m}),(0,a.jsx)(ir,{className:"large",onChange:p,options:c,value:m})]})}));var lr=n(19729);function cr(e,t){const n=e.query[t];return n&&0!==Object.keys(n).length?Object.keys(n).filter((e=>!e.startsWith("$"))).sort().map((s=>{const{meta:{docs:i,modifier:r,name:o,type:l}}=n[s],c=(0,lr.P)(e.registry,l,r.isOptional);let d="";if(l.isMap){const{hashers:t,key:n}=l.asMap;if(1===t.length)d=(0,Mi.I)(e.registry.lookup,n);else{const t=e.registry.lookup.getSiType(n).def;d=t.isTuple?t.asTuple.map((t=>(0,Mi.I)(e.registry.lookup,t))).join(", "):t.asHistoricMetaCompat.toString()}}return{className:"ui--DropdownLinked-Item",key:`${t}_${s}`,text:[(0,a.jsxs)("div",{className:"ui--DropdownLinked-Item-call",children:[s,"(",d,"): ",c]},`${t}_${s}:call`),(0,a.jsx)("div",{className:"ui--DropdownLinked-Item-text",children:(i[0]||o).toString()},`${t}_${s}:text`)],value:s}})):[]}function dr(e,{value:t}){return function(n){return e.query[t.creator.section]?e.query[t.creator.section][n]:t}}const ur=s.memo((function(e){const{api:t}=(0,z.h)(),{className:n="",isError:s,onChange:i,options:r,value:o}=e;return r.length?(0,a.jsx)(_t.Z,{className:`${n} ui--DropdownLinked-Items`,isError:s,onChange:i,options:r,transform:dr(t,e),value:o.creator.method,withLabel:!1}):null})),mr=s.memo((function({className:e="",defaultValue:t,isError:n,onChange:s,options:i,value:{creator:{section:r}}}){return(0,a.jsx)(_t.Z,{className:`${e} ui--DropdownLinked-Sections`,defaultValue:t,isError:n,onChange:s,options:i,value:r,withLabel:!1})})),hr=s.memo((function({className:e="",defaultValue:t,label:n,onChange:i,withLabel:r}){const{api:o}=(0,z.h)(),[l,c]=(0,s.useState)((()=>cr(o,t.creator.section))),[d]=(0,s.useState)((()=>function(e){return Object.keys(e.query).filter((e=>!e.startsWith("$"))).sort().filter((t=>Object.keys(e.query[t]).length)).map((e=>({text:e,value:e})))}(o))),[u,m]=(0,s.useState)((()=>t)),h=(0,s.useCallback)((e=>{u!==e&&(m((()=>e)),i&&i(e))}),[i,u]),p=(0,s.useCallback)((e=>{if(e!==u.creator.section){const t=cr(o,e);c(t),h(o.query[e][t[0].value])}}),[h,o,u]);return(0,a.jsxs)(Ii,{className:e,label:n,withLabel:r,children:[(0,a.jsx)(mr,{className:"small",onChange:p,options:d,value:u}),(0,a.jsx)(ur,{className:"large",onChange:h,options:l,value:u},u.creator.section)]})}));n(35220);var pr=n(6226),gr=n(88311);const fr=["application/wasm"],br=s.memo((function({onChange:e,...t}){const n=(0,s.useCallback)(((t,n)=>{const a=(0,pr.F)(t);e((0,gr.N)(t),a,n)}),[e]);return(0,a.jsx)(_i,{...t,accept:fr,onChange:n})}));var xr=n(55858);const Ar=(0,v.z)(gn.Z)`
...
`,vr=s.memo((function({children:e,className:t="",isDisabled:n,isError:s,isFull:i,isHidden:r,isMonospace:o,isSmall:l,isTrimmed:c,label:d,labelExtra:u,value:m,withCopy:h=!1,withLabel:p}){return(0,a.jsxs)(Ar,{className:`${t} ui--Output`,isFull:i,isHidden:r,isSmall:l,label:d,labelExtra:u,withLabel:p,children:[(0,a.jsxs)("div",{className:`ui--output ui dropdown selection ${s?" error":""}${o?" monospace":""}${n?"isDisabled":""}`,children:[c&&(0,un.H)(m)&&m.length>512?`${m.slice(0,256)}…${m.slice(-256)}`:m,e]}),h&&(0,a.jsx)(pn,{value:m})]})}));function wr({inner:e=[],name:t="",outer:n=[]},a=[]){if(n.length){const e=new Array(n.length);for(let t=0;t<n.length;t++)e[t]=(0,xr.c)(n[t],void 0,!1);a.push({name:t,value:e.join(" ")})}for(let t=0,n=e.length;t<n;t++)wr(e[t],a);return a}const yr=(0,v.z)(vr)`
  table {
    width: 100%;
...
`,jr=s.memo((function({className:e,hex:t,inspect:n,label:i}){const{t:r}=(0,Z.$)(),{createLink:o}=(0,z.h)(),l=(0,s.useMemo)((()=>n&&wr(n)),[n]),[c,d]=(0,s.useMemo)((()=>{if(t){const e=`/extrinsics/decode/${t}`;return[o(e),`#${e}`]}return[null,null]}),[o,t]);return l?(0,a.jsx)(yr,{className:e,isDisabled:!0,label:i,children:(0,a.jsx)("table",{children:(0,a.jsxs)("tbody",{children:[l.map((({name:e,value:t},n)=>(0,a.jsxs)("tr",{children:[(0,a.jsx)("td",{children:(0,a.jsx)("label",{children:e})}),(0,a.jsx)("td",{children:t})]},n))),c&&(0,a.jsxs)("tr",{className:"isLink",children:[(0,a.jsx)("td",{children:(0,a.jsx)("label",{children:r("link")})}),(0,a.jsx)("td",{children:(0,a.jsx)("a",{href:c,rel:"noreferrer",target:"_blank",children:d})})]},"hex")]})})}):null}));let Cr=0;const kr=v.z.div`
  cursor: help;
  display: inline-block;
  line-height: 1rem;
  margin: 0 0 0 0.25rem;
`,Nr=s.memo((function({className:e="",help:t,icon:n="question-circle"}){const[i]=(0,s.useState)((()=>"label-help-"+ ++Cr));return(0,a.jsxs)(kr,{className:`${e} ui--LabelHelp`,tabIndex:-1,children:[(0,a.jsx)(A.Z,{icon:n,tooltip:i}),(0,a.jsx)(w.Z,{text:t,trigger:i})]})})),Er=s.memo((function({children:e,isActive:t=!0}){const[n,i]=(0,s.useState)((()=>new Array(e.length).fill(!1)));return(0,s.useEffect)((()=>{if(t){const e=n.findIndex((e=>!e));-1!==e&&(0,la.Y)((()=>i(n.map(((t,n)=>n===e||t)))))}}),[t,n]),(0,a.jsx)(a.Fragment,{children:t?n.map(((t,n)=>t&&e[n])):(0,a.jsx)(U,{})})})),Sr=s.memo((function({children:e,className:t="",label:n,params:s}){const{api:i}=(0,z.h)(),r=(0,fe.W7)(i.derive.balances?.all,[s]);return(0,a.jsxs)("div",{className:t,children:[n||"",(0,p.u)(r?.accountNonce),e]})}));s.memo((function({className:e="",label:t,params:n}){return n?(0,a.jsx)(Sr,{className:`${e} ui--Nonce`,label:t,params:n.toString()}):null}));var Ir=n(84450);const Br=v.z.div`
  vertical-align: middle;
  white-space: nowrap;
...
`,Mr=s.memo((function({className:e="",value:t}){const{t:n}=(0,Z.$)(),s={width:100*function(e){const t=Pr().test(e),n=Math.max(0,t.passedTests.length-t.failedTests.length);return t.isPassphrase?7:n}(t)/7+"%"};return(0,a.jsxs)(Tr,{className:e,style:{display:t?"flex":"none"},children:[n("weak"),(0,a.jsx)("div",{className:"ui--Strength-bar",children:(0,a.jsx)("div",{className:"ui--Strength-bar-highlighted",style:s})}),n("strong")]})})),Fr=v.z.div`
  position: relative;
  display: flex;
  flex-direction: row;
  flex-wrap: nowrap;
...
`,zr=s.memo((function({className:e="",defaultValue:t,label:n,onChange:s,onClick:i,options:r,sortDirection:o}){return(0,a.jsxs)(Fr,{className:`${e} ui--Sort`,children:[(0,a.jsx)(_t.Z,{defaultValue:t,label:n,onChange:s,options:r}),(0,a.jsxs)("button",{onClick:i,children:[(0,a.jsx)(A.Z,{className:"arrow up"+("ascending"===o?" isActive":""),color:"gray",icon:"sort-up"}),(0,a.jsx)(A.Z,{className:"arrow down"+("descending"===o?" isActive":""),color:"gray",icon:"sort-down"})]})]})})),Zr=s.memo((function({className:e="",stakingInfo:t}){const n=t?.stakingLedger?.active?.unwrap();return n?.gtn(0)?(0,a.jsx)(te.Z,{className:e,value:n}):null}));var Rr=n(56245);function $r(e){switch(e){case"error":return"ban";case"event":case"eventWarn":return"assistive-listening-systems";case"received":return"telegram-plane";default:return"check"}}function Hr({account:e,action:t,id:n,message:s,removeItem:i,status:r}){return(0,a.jsx)("div",{className:`item ${r}`,children:(0,a.jsx)("div",{className:"wrapper",children:(0,a.jsxs)("div",{className:"container",children:[(0,a.jsx)(A.Z,{icon:"times",onClick:i}),(0,a.jsx)("div",{className:"short",children:(0,a.jsx)(A.Z,{icon:$r(r)})}),(0,a.jsxs)("div",{className:"desc",children:[(0,a.jsx)("div",{className:"header",children:Array.isArray(t)?t.map(((e,t)=>(0,a.jsx)("div",{children:e},t))):t}),e&&(0,a.jsx)(lt,{value:e}),(0,a.jsx)("div",{className:"status",children:s})]})]})})},n)}function qr({error:e,extrinsic:t,id:n,removeItem:s,rpc:i,status:r}){let{method:o,section:l}=i;if(t){const e=t.registry.findMetaCall(t.callIndex);"unknown"!==e.section&&(o=e.method,l=e.section)}const c=function(e){switch(e){case"cancelled":return"ban";case"completed":case"inblock":case"finalized":case"sent":return"check";case"dropped":case"invalid":case"usurped":return"arrow-down";case"error":case"finalitytimeout":return"exclamation-triangle";case"queued":return"random";default:return"spinner"}}(r);return(0,a.jsx)("div",{className:`item ${r}`,children:(0,a.jsx)("div",{className:"wrapper",children:(0,a.jsxs)("div",{className:"container",children:[Rr.z.includes(r)&&(0,a.jsx)(A.Z,{icon:"times",onClick:s}),(0,a.jsx)("div",{className:"short",children:"spinner"===c?(0,a.jsx)(U,{variant:"push"}):(0,a.jsx)(A.Z,{icon:c})}),(0,a.jsxs)("div",{className:"desc",children:[(0,a.jsxs)("div",{className:"header",children:[l,".",o]}),(0,a.jsx)("div",{className:"status",children:e?e.message||e.toString():r})]})]})})},n)}const Ur=v.z.div`
  display: inline-block;
  overflow: hidden;
  position: fixed;
  right: 0.75rem;
...
`,Wr=s.memo((function({children:e,className:t="",isSmall:n}){return(0,a.jsx)(Or,{className:`${t}${n?" isSmall":""}`,children:e})}));var Gr=n(73557),Jr=n(59149);const Kr=v.z.div`
...
`,Yr=s.memo((function({className:e="",icon:t,text:n}){return(0,a.jsxs)(Kr,{className:`${e} active-tab`,children:[(0,a.jsx)(A.Z,{icon:t}),(0,a.jsx)("span",{children:n})]})}));var Xr=n(39857);const _r=(0,v.z)(Xr.OL)`
  align-items: center;
  display: flex;
  color: #8B8B8B;
  height: 100%;
...
`,eo=s.memo((function({basePath:e,className:t="",count:n,hasParams:s,index:i,isExact:r,isRoot:o,name:l,text:c}){const d=o?e:`${e}/${l}`,u=r||!s||0===i;return(0,a.jsxs)(_r,{className:`${t} ui--Tab`,end:u,to:d,children:[(0,a.jsx)("div",{className:"tabLinkText",children:c}),!!n&&(0,a.jsx)(C,{className:"tabCounter",color:"counter",info:n})]})})),to=v.z.div`
  height: 100%;
  width: auto;
`,no=s.memo((function({className:e=""}){return(0,a.jsx)(to,{className:e,children:(0,a.jsx)("svg",{fill:"none",height:"47",viewBox:"0 0 17 65",width:"17",xmlns:"http://www.w3.org/2000/svg",children:(0,a.jsx)("path",{className:"highlight--stroke",d:"M1 1L16 32.5L1 64",stroke:"#D1D1D1"})})})})),ao=v.z.header`
  background: var(--bg-tabs);
...
`,so=s.memo((function({basePath:e,className:t="",hidden:n,items:i}){const r=(0,Gr.TH)(),{icon:o,text:l}=s.useContext(Jr.m),c=(0,s.useMemo)((()=>i.filter((e=>!(!e||n&&n.includes(e.name))))),[n,i]);return(0,s.useEffect)((()=>function(e,t,n,a){if(t.pathname!==e){const[,,s]=t.pathname.split("/"),i=n.find((e=>e&&e.alias===s));i?window.location.hash=i.isRoot?e:`${e}/${i.name}`:!a||!a.includes(s)&&n.some((e=>e&&!e.isRoot&&e.name===s))||(window.location.hash=e)}}(e,r,i,n)),[e,n,i,r]),(0,a.jsx)(ao,{className:`${t} ui--Tabs`,children:(0,a.jsxs)("div",{className:"tabs-container",children:[l&&o&&(0,a.jsx)(Yr,{icon:o,text:l}),(0,a.jsx)(no,{}),(0,a.jsx)("ul",{className:"ui--TabsList",children:c.map(((t,n)=>(0,a.jsx)("li",{className:t.isHidden?"--hidden":"",children:(0,s.createElement)(eo,{...t,basePath:e,index:n,key:t.name})},n)))})]})})})),io=(0,v.z)(gn.Z)`
...
`,r=s.memo((function({children:e,className:t="",withBorder:n,withExpander:s,withPadding:r}){return(0,a.jsx)(i,{className:`${t} ui--Params ${n?"withBorder":""} ${r?"withPadding":""} ${s?"withExpander":""}`,children:e})}))},98988:(e,t,n)=>{n.d(t,{Z:()=>h});var a=n(52322),s=n(2784),i=n(84277),r=n(86353),o=n(58607),l=n(6046),c=n(27113),d=n(48653),u=n(37750);const m=i.zo.div`
